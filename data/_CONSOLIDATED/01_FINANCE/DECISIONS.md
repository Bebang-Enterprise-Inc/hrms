...
| COA-175-024 | Rewrite-live supersession (was transform-on-export) | Rewrite-live BEI/BKI/III canonical 27-account Sales tree; supersedes earlier 'transform-on-export' recommendation per Sam directive 2026-06-04 'no drift'. Executed via Phase 3a 5-root seed (290 root accounts created via SSM bench execute) + Phase 3b/3c migration. | Sam Karazi (CEO) | 2026-06-04 | `docs/plans/2026-06-04-sprint-258-coa-gl-finalization-bridge-handoff.md` (S258 v1.2) |
| COA-175-025 | Per-store P&L for 4 BEI-TIN stubs | ROBINSONS ANTIPOLO, SM MANILA, SM MEGAMALL, SM SOUTHMALL get their own Frappe Companies with full canonical store template; INTERNAL MANAGEMENT REPORTING — all 4 file under BEI TIN 005-925-816-00000, NOT standalone BIR entities. Phase 2.6 seeded Sales tree (19 accounts per stub × 4 = 76). | Sam Karazi (CEO) | 2026-06-04 | `docs/plans/2026-06-04-sprint-258-coa-gl-finalization-bridge-handoff.md` (S258 v1.2) |
| COA-175-026 | BFI2 → BFT abbr rename | Frappe abbr changed BFI2→BFT on BEBANG FT INC. via Phase 1.5 A5 SSM bench execute (`flags.ignore_validate_constants` + `frappe.db.set_value`). SEC legal name unchanged (TIN 663-440-106-00000, RDO 044). 2 Cost Centers renamed; 0 tabAccount rows touched (BFT had 0 accounts pre-rename). | Sam Karazi (CEO) | 2026-06-04 | `docs/plans/2026-06-04-sprint-258-coa-gl-finalization-bridge-handoff.md` (S258 v1.2) |
| COA-175-027 | Round Off UPPER + Liability dedup | UPPER `ROUND OFF` + Expense root_type per Butch D-1.3. Phase 1.3 A3: ROBDA legacy `2120000 - ROUND OFF - ROBDA` (Liability, 2 GL postings) → JE `ACC-JV-2026-00014` transferring 0.80 PHP to canonical Expense `Round Off - ROBDA`, then disable=1. XMM (0 GL) → SET pointer + disable=1. **Deviation D1-1:** followed canonical Rule 2 disable-don't-delete instead of plan's DELETE-with-ignore_links (which would corrupt GL Entry trail). | Sam Karazi (CEO) | 2026-06-04 | `docs/plans/2026-06-04-sprint-258-coa-gl-finalization-bridge-handoff.md` (S258 v1.2) |
| COA-175-028 | AP/AR suffix to abbr | All BEI control accounts renamed from `- Bebang Enterprise Inc.` long-form to `- BEI` abbr form via Phase 3.5 mass rename (286 rename total across long-suffix entities). ERPNext-native cascade + S196/S199 precedent; closes Butch OQ-4 open item. | Sam Karazi (CEO) | 2026-06-04 | `docs/plans/2026-06-04-sprint-258-coa-gl-finalization-bridge-handoff.md` (S258 v1.2) |
| COA-175-029 | VAT Input 4 stems preserved per BIR 2550Q Schedule 3 | Goods/Importation/Services regulation-driven per BIR Form 2550Q (2550M abolished per RMC 5-2023, confirmed by TAX-007 + `BIR_FILING_CALENDAR_2026-02-27.csv`); Inter-Co stem management-control per Butch ICT-001. Phase 1 preserved all 4 stems on PARTIAL companies; no consolidation. | Sam Karazi (CEO) | 2026-06-04 | `docs/plans/2026-06-04-sprint-258-coa-gl-finalization-bridge-handoff.md` (S258 v1.2) |
| COA-175-030 | 4000900 discount renumber executed | Butch COA-175-002 lock executed. Phase 4 created `4000900 - DISCOUNTS AND PROMO` group account under SALES tree on per-Company basis (where SALES tree exists). 0 legacy 4000201-208 rows found needing renumber (already canonical post Phase 3a seeding). GL Entry trail preserved via rename_doc cascade. | Sam Karazi (CEO) | 2026-06-04 | `docs/plans/2026-06-04-sprint-258-coa-gl-finalization-bridge-handoff.md` (S258 v1.2) |
