...
| `S172` | Sprint 172 | `s172-s166-followup-defect-fixes` | — | PLANNED 2026-04-08 — Follow-up defect-fix sprint addressing 15 OPEN/PARTIAL product defects after S166 closeout + S170 partial deploy + 2026-04-08 audit (PR #496). Phase 1: Defects #6+#21 compensation Edit + list-modal. Phase 2: Defect #16 _activate_compensation_change silent failure. Phase 3: Defect #19 OT/apply RoleGuard. Phase 4: Defect #18 BEI Incident Report Warehouse→Branch. Phase 5: Defect #8 create_employee_direct cached employee_id. Phase 6: Defect #13 emergency_phone_number drop. Phase 7: Smaller defects (#5, #9, #11, #14, #15, #20). Phase 8: L3 retest of ~25 scenarios unblocked by the fixes (mandatory independent audit gate per post-#497 rule). Phase 9: Closeout + **mandatory S173 ledger update** (flip retested rows from PENDING to CLOSED). 70 units, cold-start ready. Fact-check patches in PR #501. **Does NOT burn down the 86-row S166 test debt — see S173 ledger + S174 burn-down sprint.** | `docs/plans/2026-04-08-sprint-172-s166-followup-defect-fixes.md` |
...
1. Next canonical sprint ID to assign: `S178`.
