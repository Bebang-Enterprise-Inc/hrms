...
| `S167` | Sprint 167 | `s167-pcf-full-acceptance-test-redo` | — | IN_PROGRESS 2026-04-07 (REOPENED) — First pass rejected by Sam: 7 of 22 scenarios actually ran in browser, rest were API-driven cop-outs or blocked. REDO: browser-only, per-scenario confirmation, `/frappe-bulk-edits` authorized to unblock DEFECT-004 warehouse. Must report ALL defects including out-of-scope. First pass outcomes retained: 8 defects surfaced, 5 fixed via hrms#474, #476, #478 + BEI-Tasks#349, #350. | `docs/plans/2026-04-06-sprint-167-pcf-full-acceptance-test.md` |
