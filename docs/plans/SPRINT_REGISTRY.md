...
| `S175` | Sprint 175 | `s175-coa-master-template-uniform-group-restructure` | — | PLANNED 2026-04-09 — COA master template + uniform Bebang Group restructure. Apply Butch Formoso's 2026-04-08 canonical GL Sales tree as a uniform master COA across all 40 Bebang Group Frappe Companies, create BEBANG FRANCHISE CORP. as a new Frappe Company, fix 134-account BEI expense misclassification, set up intercompany liability scaffolding for Phase 2 BFC bank-account cutover. hrms-only (seed scripts, SSM orchestration, verification) — NO application code changes. Depends on S168 merged+deployed. (Retroactively registered 2026-04-09; plan was on disk but missing from registry.) | `docs/plans/2026-04-09-sprint-175-coa-master-template-uniform-group-restructure.md` |
