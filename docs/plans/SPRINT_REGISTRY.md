...
| `S167` | Sprint 167 | `s167-pcf-full-acceptance-test` | 2026-04-07 | COMPLETED — 15/22 scenarios PASS. Phase 1 (store lifecycle) BLOCKED by DEFECT-004 (missing `TEST-STORE-BGC - BEI` warehouse). 8 PCF defects surfaced during run; 5 fixed in-run via hrms#474, #476, #478 and BEI-Tasks#349, #350; 3 open (DEFECT-004 warehouse, DEFECT-009 AI classifier naked COA codes, DEFECT-005 finance review route UX). All test data rolled back in Phase 6. Evidence: `output/l3/s167/L3_FINAL_REPORT.md`. | `docs/plans/2026-04-06-sprint-167-pcf-full-acceptance-test.md` |
