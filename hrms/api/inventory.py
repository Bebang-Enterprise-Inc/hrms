...
def get_cycle_counts(
	store=None, date_from=None, date_to=None, status=None, count_type=None, external_auditor=None, limit=20
):
...
@frappe.whitelist()
def report_variance(
	store, item_code, system_qty=0, actual_qty=0, variance_type=None, explanation=None, photo=None
):
...
def request_shelf_extension(
	store, item_code, original_expiry, requested_expiry, quantity, reason, batch_no=None, photo=None
):
