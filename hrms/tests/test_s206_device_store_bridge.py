...
class DeviceStoreBridgeTests(unittest.TestCase):
    ...
    def test_ho_device_routes_to_bei_parent(self):
        ...
        with patch.object(
            company_lookup, "_load_store_company_index", return_value=mock_idx
        ):
    ...
    def test_shaw_commissary_dept_commissary_routes_to_bki(self):
        ...
        with patch.object(
            ...
            result = resolve_device_company(
                "UDP3235200629", department="Commissary"
            )
