...
| 5 | Concurrency stress test | DONE | output/s225/verification/pattern_a_concurrency_{results.json,summary.md} | NO | 10/10 success, 0 negative-stock, 0 MySQL 1213 deadlocks. Per-call elapsed 7.5s→27.5s shows perfect serialization through the FOR UPDATE lock. Source: PINNACLE COLD STORAGE SOLUTIONS - BKI, item PM007 (auto-discovered from existing Ordered MR MAT-MR-2026-00135). Created 10 SEs (MAT-STE-2026-01039..01048), all cancelled in cleanup. |
