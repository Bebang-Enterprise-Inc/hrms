#!/usr/bin/env python3
"""SSM wrapper for phase4b_master_data.py."""
...
SCRIPT = HERE / "phase4b_master_data.py"
OUT = Path(__file__).parent.parent.parent / "output/l3/s247/verification/phase4b_result.json"
...
cmds = [
    ...
    f"echo '{encoded}' | base64 -d > /tmp/s247_p4b.py",
    "docker cp /tmp/s247_p4b.py $BACKEND:/tmp/s247_p4b.py",
    "docker exec $BACKEND bash -lc 'cd /home/frappe/frappe-bench && env/bin/python /tmp/s247_p4b.py'",
    "docker cp $BACKEND:/tmp/s247_p4b_result.json /tmp/s247_p4b_result.json",
    "gzip -c /tmp/s247_p4b_result.json > /tmp/s247_p4b_result.json.gz",
    "echo S247_FILE_BEGIN",
    "base64 -w0 /tmp/s247_p4b_result.json.gz; echo",
    "echo S247_FILE_END",
]
