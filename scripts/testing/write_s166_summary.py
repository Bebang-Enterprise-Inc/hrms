"""Write canonical S166 SUMMARY.md"""

content = """# S166 Final Summary — L3 Employee Lifecycle Coverage
...
with open('F:/Dropbox/Projects/BEI-ERP/output/l3/s166/SUMMARY.md', 'w', encoding='utf-8') as f:
    f.write(content)

print("SUMMARY.md written successfully")
