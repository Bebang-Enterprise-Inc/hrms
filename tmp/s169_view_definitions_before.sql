...
-- === VIEW: public.v_all_channel_daily ===
...
-- === VIEW: public.v_monthly_store_summary ===
...
-- === VIEW: public.v_discount_identity_order_usage ===
CREATE OR REPLACE VIEW public.v_discount_identity_order_usage AS
 ...
 SELECT business_date,
   ...
   FROM identity_usage;
-- === VIEW: public.v_discount_identity_rolling_30d_usage ===
 WITH base AS (
